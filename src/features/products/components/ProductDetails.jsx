...
export const ProductDetails = () => {
    ...
    const totalReviewRating = reviews?.reduce((acc, review) => acc + (review?.rating || 0), 0) || 0;
                                                ...
                                                <Stack flexDirection={'row'} columnGap={is387 ? ".5rem" : ".2rem"} >
                                                    {
                                                        COLORS.map((color, index) => (
                                                            <div style={{ backgroundColor: "black", border: selectedColorIndex === index ? `1px solid ${theme.palette.primary.dark}` : "", width: is340 ? "40px" : "50px", height: is340 ? "40px" : "50px", display: "flex", justifyContent: "center", alignItems: "center", borderRadius: "100%", }}>
